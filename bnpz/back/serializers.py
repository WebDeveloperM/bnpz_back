...
from bnpz.models import New, Video, Message, Product, FAQ, Gallery, Selection, CategoryNew, CategoryTender, \
    SelectionProduct, Site, Statistic, Certificate, LocalDocs, Lider, Captcha
